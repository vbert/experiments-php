...
<body class="regionb">
    <div id="nav">
        ...
        ?>
        <div id="regionsNav">
            <div class="flagg"><div id="setPL" class="poland"></div> Polska: </div>
            <?php
                foreach($allRegions['pl'] as $region) {
                    $xcss = '';
                    if($region==$regName) {
                        $xcss = 'class="oranged" ';
                    }
